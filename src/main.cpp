...
int main() {
    ...
    std::cout << "Length: " << str.Length() << "\tMultiByteLength: " << str.LengthMultiByte() << "\n";
    std::cout << "\n";

    String str_empty;
    std::cout << str_empty << "\n\tLength = " << str_empty.Length() << "\tMultiByteLength: "
              << str_empty.LengthMultiByte() << "\n";
    ...
    std::cout << "Length: " << str01.Length() << "\tMultiByteLength: " << str01.LengthMultiByte() << "\n";
